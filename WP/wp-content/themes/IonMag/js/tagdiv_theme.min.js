...
2;c+g.outerHeight(!0)>window.innerHeight&&(c-=c+g.outerHeight(!0)-window.innerHeight);l=l.length?l.outerHeight(!0):0;l>c&&(c=l);l={top:c,right:f,"padding-right":n,width:""};c=g.data("width-preview");0<n&&(l.width=c+n);g.css(l);g.data("right-value",f+n);g.css("visibility","visible")},function(c){a(".td-screen-demo-extend:first").hide();var d=a(".td-screen-demo:first");c=d.css("right");var e=d.css("padding-right"),g=d.css("width"),l=parseInt(c.replace("px","")),f=parseInt(e.replace("px","")),n=parseInt(g.replace("px",
...
tdDemoMenu.startInterval=b);a(this).css("visibility","hidden");a(".td-screen-demo-extend:first").hide()}).mousemove(function(a){});a(".td-screen-demo-extend").hover(function(c){if(tdDemoMenu._extendedDemo){tdDemoMenu._extendedDemo=!1;var d=a(this),e=a(".td-screen-demo:first"),g=parseInt(a("#td-theme-settings").css("width").replace("px",""))/2,l=g;d.css({width:g+"px",top:e.css("top")});d.show();e.css("visibility","visible");tdDemoMenu._startExtendedTimeout=setTimeout(function(){tdDemoMenu._startExtendedInterval=
setInterval(function(){l-=10;var c=!1;if(0>l||tdDemoMenu.mousePosX<=a(window).width()-g-l)b!==tdDemoMenu._startExtendedTimeout&&(window.clearTimeout(tdDemoMenu._startExtendedTimeout),tdDemoMenu._startExtendedTimeout=b),b!==tdDemoMenu._startExtendedInterval&&(window.clearInterval(tdDemoMenu._startExtendedInterval),tdDemoMenu._startExtendedInterval=b),tdDemoMenu.mousePosX<=a(window).width()-g-l&&(c=!0),l=g,d.hide();d.css({width:l,top:e.css("top")});c&&tdDemoMenu._checkMousePosition()},15)},50)}},function(c){b!==
...
c.outerHeight(!0)/2,e=e.length?e.outerHeight(!0):0;e>g&&(g=e);0>g?g=0:a(window).height()-c.outerHeight(!0)/2<b.pageY-document.body.scrollTop&&(g=a(window).height()-c.outerHeight(!0));c.css("top",g)},_resetTdScreeDemoExtendWidth:function(){var b=parseInt(a("#td-theme-settings").css("width").replace("px",""))/2;a(".td-screen-demo-extend:first").css({width:b+"px"})},_showExtendedScreenDemo:function(){tdDemoMenu._extendedDemo&&a(".td-screen-demo-extend:first").css({top:a(".td-screen-demo:first").css("top")}).show()},
...
parseInt(d.outerWidth())&&(f=!0));else{var n=d.prev(".td-set-theme-style");n.length&&parseInt(n.position().top)+parseInt(a(window).scrollTop())<tdDemoMenu.mousePosY&&tdDemoMenu.mousePosY<parseInt(n.position().top)+parseInt(a(window).scrollTop())+parseInt(n.outerHeight())&&(l=!0,parseInt(a(window).width())-parseInt(d.outerWidth())<tdDemoMenu.mousePosX&&tdDemoMenu.mousePosX<parseInt(a(window).width())&&(f=!0))}if(l&&f)return c=e,!1});b===c?a("#td-theme-settings").find(".td-screen-demo:first").css("visibility",
