...
window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:h,action:"tdc_ajax_get_image_id"}}).done(function(a,h,f){if("success"===h)if(b.isObject(a)&&b.has(a,"errors"))tdcNotice.notice(a.errors,!0,!1);else{h=c.closest(".tdc-property-wrap");f=h.find(".tdc-css-image-remove");var e=h.find(".tdc-inherit-image");f.removeClass("tdc-hidden-button");"all"===tdcCssEditor._currentViewportSettings.name?e.hide():e.show();c.attr("style","background-image: url( '"+d+"') ");c.data("image_link",d);
c.data("image_id",a.image_id);window.send_to_editor=window.original_send_to_editor;window.tb_remove();h.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);"undefined"===typeof c.data("model_id")?tdcCssEditor.saveWidgetForm(c):(a=tdcCssEditor._generateCssAttValue(g),h=tdcIFrameData.getModel(c.data("model_id")),tdcSidebarController.onUpdate(h,c.data("param_name"),"",a))}}).fail(function(a,c,b){})};return!1},tdcCssImageRemoveHandler:function(a){var c=e(a.currentTarget),g=c.closest(".tdc-property-wrap");
...
c));h={isInherited:!1};c=tdcCssEditor._getSettingsProperty("background-image",d,h);h.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),g.attr("style","background-image: url('"+c+"'")):g.attr("style","background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'")},_clearCssProperties:function(a){if(window.confirm("All CSS of the selected component will be deleted! Are you sure?")){tdcCssEditor._currentCssSettings=d;a=e(a.currentTarget);var c=a.data("model_id");
"undefined"===typeof c?(e(".tdc-responsiveness").replaceWith(tdcCssEditor._generateEditorResponsiveContent()),tdcCssEditor.doActionPanelRender(),tdcCssEditor.saveWidgetForm(e("."+a.get(0).className))):(c=tdcIFrameData.getModel(c),tdcSidebarController.onUpdate(c,a.data("param_name"),"",""),e(".tdc-responsiveness").replaceWith(tdcCssEditor._generateEditorResponsiveContent()),tdcCssEditor.doActionPanelRender())}},_changeTextInput:function(a){a=e(a.currentTarget);var c=a.parent(),b=a;c.hasClass("tdc-box-margin")||
c.hasClass("tdc-box-border")||c.hasClass("tdc-box-padding")||(b=a.closest(".tdc-property-wrap"));tdcCssEditor._updateData(a);var d=b.data("tdc-for"),c={isInherited:!1},d=tdcCssEditor._getSettingsProperty(d,"",c);c.isInherited?(a.attr("placeholder",d),a.val(""),b.addClass(tdcCssEditor._INHERITED_CSS_CLASS)):b.removeClass(tdcCssEditor._INHERITED_CSS_CLASS)},_changeDropDown:function(a){a=e(a.currentTarget);var c=a.closest(".tdc-property-wrap"),d=c.find(".tdc-inherit-select");c.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);
tdcCssEditor._updateData(a);var h=c.data("tdc-for"),f={isInherited:!1};tdcCssEditor._getSettingsProperty(h,"",f);f.isInherited?(c.addClass(tdcCssEditor._INHERITED_CSS_CLASS),d.hide()):(c.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),"all"===tdcCssEditor._currentViewportSettings.name?d.hide():0===a[0].selectedIndex?b.isUndefined(tdcCssEditor._currentCssSettings.all)||b.isUndefined(tdcCssEditor._currentCssSettings.all[h])?d.hide():d.show():d.show())},doActionPanelRender:function(){tdcSidebarPanel._hook.doAction("panel_rendered");
tdcSidebarPanel._hook.doAction("panel_css")},_bindEvents:function(){var a=e("body");a.on("keyup",".tdc-tab-design input.tdc-css-box-input",tdcCssEditor._changeTextInput);a.on("change keyup",".tdc-tab-design .tdc-css-bg-color",tdcCssEditor._changeColor);a.on("change keyup",".tdc-tab-design .tdc-css-border-color",tdcCssEditor._changeColor);a.on("change",".tdc-tab-design .tdc-css-border-style",tdcCssEditor._changeDropDown);a.on("keyup",".tdc-tab-design input.tdc-css-border-radius",tdcCssEditor._changeTextInput);
a.on("change",".tdc-tab-design .tdc-css-bg-style",tdcCssEditor._changeDropDown);a.on("change",".tdc-tab-design .tdc-css-bg-position",tdcCssEditor._changeDropDown);a.on("keyup",".tdc-tab-design input.tdc-css-opacity",tdcCssEditor._changeTextInput);a.on("change keyup",".tdc-tab-design input.tdc-css-color-1-overlay",tdcCssEditor._changeColor);a.on("change keyup",".tdc-tab-design input.tdc-css-color-2-overlay",tdcCssEditor._changeColor);a.on("mousedown",".tdc-tab-design .wp-picker-clear",tdcCssEditor._clearColorPicker);
a.on("mousedown",".tdc-tab-design .wp-color-result",tdcCssEditor._showColorPicker);a.on("click",".tdc-tab-design .tdc-inherit-select",tdcCssEditor._inheritSelect);a.on("click",".tdc-tab-design .tdc-inherit-color",tdcCssEditor._inheritColor);a.on("click",".tdc-tab-design .tdc-css-image-wrap",tdcCssEditor.tdcCssImageWrapHandler);a.on("click",".tdc-tab-design .tdc-css-image-remove",tdcCssEditor.tdcCssImageRemoveHandler);a.on("click",".tdc-tab-design .tdc-inherit-image",tdcCssEditor._inheritImage);a.on("click",
".tdc-clear-css-properties",tdcCssEditor._clearCssProperties);a.on("click",".tdc-tab-design .tdc-responsive-buttons > div",function(a){var c=e(this);c.addClass("selected");c.siblings().removeClass("selected");var h;h="undefined"===typeof window.td_viewport_interval_list?tdcAdminIFrameUI._liveIframeWindowObject.td_viewport_interval_list:window.td_viewport_interval_list;a=tdcAdminIFrameUI.getLiveIframe();c.hasClass("tdc-responsive-all")?(tdcCssEditor._currentViewportSettings={name:"all",settings:d},
b.isUndefined(a)||a.css("width","100%")):c.hasClass("tdc-responsive-tablet-landscape")?(tdcCssEditor._currentViewportSettings={name:"landscape",settings:{limitTop:h[2].limitBottom,limitBottom:parseInt(h[1].limitBottom)+1}},b.isUndefined(a)||a.css("width",tdcCssEditor._currentViewportSettings.settings.limitTop)):c.hasClass("tdc-responsive-tablet-portrait")?(tdcCssEditor._currentViewportSettings={name:"portrait",settings:{limitTop:h[1].limitBottom,limitBottom:parseInt(h[0].limitBottom)+1}},b.isUndefined(a)||
a.css("width",tdcCssEditor._currentViewportSettings.settings.limitTop)):c.hasClass("tdc-responsive-phone")&&(tdcCssEditor._currentViewportSettings={name:"phone",settings:{limitTop:h[0].limitBottom,limitBottom:d}},b.isUndefined(a)||a.css("width",tdcCssEditor._currentViewportSettings.settings.limitTop-300));e(".tdc-responsiveness").replaceWith(tdcCssEditor._generateEditorResponsiveContent());tdcCssEditor.doActionPanelRender();b.isUndefined(a)||(c=a.contents().find(".tdc-element-selected"),c.length&&
(c=c.offset().top,a.contents().scrollTop(c)))})},_updateData:function(a){var c=a.data("model_id"),b=a.data("param_name"),d=a.closest(".tdc-tab-content");"undefined"===typeof c?tdcCssEditor.saveWidgetForm(a):(a=tdcIFrameData.getModel(c),d=tdcCssEditor._generateCssAttValue(d),tdcSidebarController.onUpdate(a,b,"",d))},saveWidgetForm:function(a){var c=a.closest("form");a=a.closest(".tdc-tab-content");if(c.length){var b=c.find('input[name="id_base"]').val(),d=c.find('input[name="widget-id"]').val().replace(b+
"-",""),b="'widget-"+b+"["+d+"][tdc_css]'",d=c.find("input[name="+b+"]"),f=tdcCssEditor._generateCssAttValue(a);a.data("tdc_css",f);d.length?d.val(f):c.append('<input type="hidden" name='+b+' value="'+f+'">')}},addWidgetCssEditor:function(a,c){tdcCssEditor._mappedParameter=a;return tdcCssEditor._generateEditorContent(c)},addComposerCssEditor:function(a,c){tdcCssEditor._mappedParameter=a;tdcCssEditor._model=c;var b=c.get("attrs")[a.param_name];return tdcCssEditor._generateEditorContent(b)},_CsWpColorPicker:function(a){var c=
a.closest(".tdc-property-wrap");a.cs_wpColorPicker();c.find(".wp-color-result");c.hasClass(tdcCssEditor._INHERITED_CSS_CLASS)?(c=c.find(".wp-color-result"),""!==a.attr("placeholder")&&c.attr("style","background-color: "+tdcCssEditor._getRgba(a.attr("placeholder")))):("no_value"===a.val()&&a.val(""),tdcCssEditor._checkDefaultColor(a))},_checkDefaultColor:function(a){var c=a.closest(".tdc-property-wrap").find(".wp-color-result");""===a.val()&&(a=a.data("default_value"),b.isUndefined(a)?c.attr("style",
""):c.attr("style","background-color: "+tdcCssEditor._getRgba(a)))},_generateEditorContent:function(a){if(b.isEmpty(a))tdcCssEditor._currentCssSettings=d;else try{var c=JSON.parse(window.atob(a));tdcDebug.log(c);b.isObject(c)?tdcCssEditor._currentCssSettings=c:tdcCssEditor._currentCssSettings=d}catch(f){tdcCssEditor._currentCssSettings=d,tdcNotice.notice(f.message,!1,!1)}tdcSidebarPanel._hook.addAction("panel_rendered",function(){e(".tdc-css-image-wrap").each(function(a,c){var g=e(c),f=g.closest(".tdc-property-wrap"),
h=f.find(".tdc-css-image-remove"),m=f.find(".tdc-inherit-image"),q={isInherited:!1},u=tdcCssEditor._getSettingsProperty("background-image",d,q);q.isInherited?f.addClass(tdcCssEditor._INHERITED_CSS_CLASS):f.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);b.isUndefined(u)?(h.addClass("tdc-hidden-button"),m.hide()):("no_value"===u?h.addClass("tdc-hidden-button"):(h.removeClass("tdc-hidden-button"),g.attr("style",'background-image: url("'+u+'")')),"all"!==tdcCssEditor._currentViewportSettings.name&&m.show());
g.data("image_link",u)});e(".tdc-inherit").each(function(a,c){var g=e(c),f=g.closest(".tdc-property-wrap");if("all"===tdcCssEditor._currentViewportSettings.name||f.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))g.hide();else{var h=f.data("tdc-for"),f={isInherited:!1},h=tdcCssEditor._getSettingsProperty(h,d,f);f.isInherited?g.hide():b.isUndefined(h)||g.show()}})});var g=c="",h="";a="";switch(tdcCssEditor._currentViewportSettings.name){case "all":c="selected";break;case "landscape":g="selected";break;
case "portrait":h="selected";break;case "phone":a="selected"}c='<div class="tdc-responsive-buttons">'+('<div class="tdc-responsive-all '+c+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>')+('<div class="tdc-responsive-tablet-landscape '+g+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>')+('<div class="tdc-responsive-tablet-portrait '+h+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>');c+='<div class="tdc-responsive-phone '+
a+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';c+="</div>";return c+=tdcCssEditor._generateEditorResponsiveContent()},_cleanCss:function(a,c){if("undefined"===typeof c)return d;if("no_value"===c)return c;if("background-image"===a){var g=/(url\s*\(\s*['"]?)(.*?)\s*(['"]?\s*\))/ig.exec(c);return b.isEmpty(g)?"":g[2]}c=c.toLowerCase();c=c.replace(/!important|px/g,"");return c.trim()},_getDataNoValue:function(a){var c="";"no_value"===a&&(c=' data-no_value="1" ');return c},_generateEditorResponsiveContent:function(){function a(){return n=
{isInherited:!1}}function c(a){return"all"!==tdcCssEditor._currentViewportSettings.name?'placeholder="'+a+'"':""}function g(){return n.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function h(c,d){var f=tdcCssEditor._getSettingsProperty(c,d,a()),h="-",e="";n.isInherited&&(h=f,f="");b.isUndefined(l)||"margin-left"!==c&&"margin-right"!==c||(e=l.get("tag"),e="vc_column"===e||"vc_column_inner"===e?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+c+'" name="" type="text" value="'+
f+'" class="tdc-css-box-input tdc-css-box-input-'+c+g()+e+'" title="Css '+c+'" placeholder="'+h+'" '+tdcSidebarPanel._getParamterDataAtts(m,l)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var f,m=tdcCssEditor._mappedParameter,l=tdcCssEditor._model,n={isInherited:!1};f='<div class="tdc-responsiveness">'+('<div class="'+tdcSidebarPanel._getParameterClasses(m)+'">');f=f+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+h("margin-top","");f+=h("margin-right","");f+=h("margin-bottom",
"");f+=h("margin-left","");f=f+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+h("border-top-width","");f+=h("border-right-width","");f+=h("border-bottom-width","");f+=h("border-left-width","");f=f+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+h("padding-top","");f+=h("padding-right","");f+=h("padding-bottom","");f+=h("padding-left","");f+="</div></div></div></div>";var k=tdcCssEditor._getSettingsProperty("border-style",d,a());f+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+
g()+'" data-tdc-for="border-style">';f=f+'<div class="tdc-property-title"><span title="Css border-style">Border style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+('<select class="tdc-css-border-style" '+tdcSidebarPanel._getParamterDataAtts(m,l)+' name="">');f+=tdcCssEditor._generateDropdownOptions([{value:"solid",display:"Solid"},{value:"dotted",display:"Dotted"},{value:"dashed",display:"Dashed"},{value:"none",display:"None"},
{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},{value:"inherit",display:"Inherit"}],k);f+="</select></div></div>";var r=b.uniqueId(),k=tdcCssEditor._getSettingsProperty("border-color","",a()),q="";n.isInherited&&(q=k,k="");f+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+g()+'" data-tdc-for="border-color">';
f=f+'<div class="tdc-property-title"><span title="Css border-color">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property">'+('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(m,l)+tdcCssEditor._getDataNoValue(k)+' data-default_value="#888888" id="'+r+'" name="" type="text" '+c(q)+' value="'+k+'"/>');f+="</div></div>";tdcSidebarPanel._hook.addAction("panel_css",function(){tdcCssEditor._CsWpColorPicker(e("#"+
r))});k=tdcCssEditor._getSettingsProperty("border-radius","",a());q="";n.isInherited&&(q=k,k="");f+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+g()+'" data-tdc-for="border-radius">';f=f+'<div class="tdc-property-title"><span title="Css border-radius">Border radius</span></div><div class="tdc-property">'+('<input class="tdc-css-border-radius" '+tdcSidebarPanel._getParamterDataAtts(m,l)+' name="" type="text" '+c(q)+' value="'+k+'"/>');f+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator "></div>';
var u=b.uniqueId(),k=tdcCssEditor._getSettingsProperty("background-color","",a()),q="";n.isInherited&&(q=k,k="");f+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+g()+'" data-tdc-for="background-color">';f=f+'<div class="tdc-property-title"><span title="Css background-color">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property">'+('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(m,
l)+tdcCssEditor._getDataNoValue(k)+' id="'+u+'" name="" type="text" '+c(q)+' value="'+k+'"/>');f+="</div></div>";tdcSidebarPanel._hook.addAction("panel_css",function(){tdcCssEditor._CsWpColorPicker(e("#"+u))});tdcCssEditor._getSettingsProperty("background-image",d,a());f+='<div class="tdc-property-wrap tdc-property-attach_image'+g()+'">';f=f+'<div class="tdc-property-title"><span title="Css background-image">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property">'+
('<div class="tdc-css-bg-image tdc-css-image-wrap " '+tdcSidebarPanel._getParamterDataAtts(m,l)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");f+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';k=tdcCssEditor._getSettingsProperty("background-style",d,a());f+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+g()+'" data-tdc-for="background-style">';f=f+'<div class="tdc-property-title"><span title="Css background-size & background-repeat">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-style" '+tdcSidebarPanel._getParamterDataAtts(m,l)+' name="">');f+=tdcCssEditor._generateDropdownOptions([{value:"cover",display:"Cover"},{value:"contain",display:"Contain"},{value:"no-repeat",display:"No repeat"},{value:"repeat",display:"Repeat"}],k);f+="</select></div></div>";k=tdcCssEditor._getSettingsProperty("background-position",d,a());f+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+g()+'" data-tdc-for="background-position">';f=f+'<div class="tdc-property-title"><span title="Css background-position">Background position<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-position" '+tdcSidebarPanel._getParamterDataAtts(m,l)+' name="">');f+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",
display:"Right Bottom"}],k);f+="</select></div></div>";k=tdcCssEditor._getSettingsProperty("opacity","",a());q="";n.isInherited&&(q=k,k="");f+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+g()+'" data-tdc-for="opacity">';f=f+'<div class="tdc-property-title"><span title="Css background-image opacity">Opacity</span></div><div class="tdc-property">'+('<input class="tdc-css-opacity" '+tdcSidebarPanel._getParamterDataAtts(m,l)+' name="" type="text" '+c(q)+' value="'+k+'"/>');f+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div>';
var v=b.uniqueId(),k=tdcCssEditor._getSettingsProperty("color-1-overlay","",a()),q="";n.isInherited&&(q=k,k="");f+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+g()+'" data-tdc-for="color-1-overlay">';f=f+'<div class="tdc-property-title"><span title="Css gradient color From">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property">'+('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(m,
l)+tdcCssEditor._getDataNoValue(k)+' id="'+v+'" name="" type="text" '+c(q)+' value="'+k+'"/>');f+="</div></div>";tdcSidebarPanel._hook.addAction("panel_css",function(){tdcCssEditor._CsWpColorPicker(e("#"+v))});var w=b.uniqueId(),k=tdcCssEditor._getSettingsProperty("color-2-overlay","",a()),q="";n.isInherited&&(q=k,k="");f+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+g()+'" data-tdc-for="color-2-overlay">';f=f+'<div class="tdc-property-title"><span  title="Css gradient color To">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property">'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(m,l)+tdcCssEditor._getDataNoValue(k)+' id="'+w+'" name="" type="text" '+c(q)+' value="'+k+'"/>');f+="</div></div>";tdcSidebarPanel._hook.addAction("panel_css",function(){tdcCssEditor._CsWpColorPicker(e("#"+w))});f=f+'<div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div>'+('<div class="tdc-clear-css-properties" '+tdcSidebarPanel._getParamterDataAtts(m,
l)+' title="Clear all tab css settings">Clear CSS settings</div>');return f+"</div>"},_getAvailableViewportSetting:function(a,c,b){if("undefined"!==typeof tdcCssEditor._currentCssSettings){var d;switch(a){case "all":"undefined"!==typeof tdcCssEditor._currentCssSettings[a]&&(d="all");break;case "landscape":case "portrait":case "phone":"undefined"!==typeof tdcCssEditor._currentCssSettings[a]?d=a:"undefined"!==typeof tdcCssEditor._currentCssSettings.all&&(d="all")}if("undefined"!==typeof d){if("undefined"!==
...
a,b));"undefined"===typeof d&&"undefined"!==typeof c&&(d=c);return d},_generateDropdownOptions:function(a,c,d){for(var g=[],f,e=!1,l=0,n=0;n<a.length;n++)b.isUndefined(d)||d!==a[n].value||(l=n),f="",b.isUndefined(c)||c!==a[n].value||(f='selected="selected"',e=!0),g.push("<option "+f+' value="'+a[n].value+'">'+a[n].display+"</option>");e||(g[l]='<option selected="selected" value="'+a[l].value+'">'+a[l].display+"</option>");return g.join("")},_generateCssAttValue:function(a){var c={},d=a.find(".tdc-css-box-input-margin-top").val().trim(),
e=a.find(".tdc-css-box-input-margin-right").val().trim(),f=a.find(".tdc-css-box-input-margin-bottom").val().trim(),m=a.find(".tdc-css-box-input-margin-left").val().trim(),l=a.find(".tdc-css-box-input-border-top-width").val().trim(),n=a.find(".tdc-css-box-input-border-right-width").val().trim(),k=a.find(".tdc-css-box-input-border-bottom-width").val().trim(),r=a.find(".tdc-css-box-input-border-left-width").val().trim(),q=a.find(".tdc-css-box-input-padding-top").val().trim(),u=a.find(".tdc-css-box-input-padding-right").val().trim(),
v=a.find(".tdc-css-box-input-padding-bottom").val().trim(),w=a.find(".tdc-css-box-input-padding-left").val().trim(),p=a.find(".tdc-css-border-radius").val().trim(),t=a.find(".tdc-css-opacity").val().trim();""!==d&&(c["margin-top"]=d);""!==e&&(c["margin-right"]=e);""!==f&&(c["margin-bottom"]=f);""!==m&&(c["margin-left"]=m);""!==l&&(c["border-top-width"]=l);""!==n&&(c["border-right-width"]=n);""!==k&&(c["border-bottom-width"]=k);""!==r&&(c["border-left-width"]=r);""!==q&&(c["padding-top"]=q);""!==u&&
(c["padding-right"]=u);""!==v&&(c["padding-bottom"]=v);""!==w&&(c["padding-left"]=w);d=a.find(".tdc-css-border-style");e=d.val().trim();""===e||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["border-style"]=e);d=a.find(".tdc-css-border-color");e=d.val().trim();""!==e?c["border-color"]=e:(d=d.data("no_value"),b.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==p&&(c["border-radius"]=p);p=a.find(".tdc-css-bg-color");d=p.val().trim();""!==d?c["background-color"]=
d:(p=p.data("no_value"),b.isUndefined(p)||1!==p||(c["background-color"]="no_value"));p=a.find(".tdc-css-bg-image");p.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(p=p.data("image_link"),b.isUndefined(p)||("no_value"===p?c["background-image"]="no_value":""!==p&&(c["background-image"]='url("'+p+'")')));p=a.find(".tdc-css-bg-style");d=p.val().trim();""===d||p.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-style"]=d);p=a.find(".tdc-css-bg-position");
d=p.val().trim();""===d||p.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-position"]=d);""!==t&&(c.opacity=t);t=a.find(".tdc-css-color-1-overlay");p=t.val().trim();""!==p?c["color-1-overlay"]=p:(t=t.data("no_value"),b.isUndefined(t)||1!==t||(c["color-1-overlay"]="no_value"));a=a.find(".tdc-css-color-2-overlay");t=a.val().trim();""!==t?c["color-2-overlay"]=t:(a=a.data("no_value"),b.isUndefined(a)||1!==a||(c["color-2-overlay"]="no_value"));b.isUndefined(tdcCssEditor._currentCssSettings)&&
...
init:function(){var b=jQuery("body");b.on("change focus",".tdc-tab-no-design .tdc-property-dropdown:not(.tdc-row-col-dropdown):not(.tdc-innerRow-col-dropdown) select",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{console.log("on change: Select");b=jQuery(this).val();var a=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(a,jQuery(this).data("param_name"),this.oldValue,b);this.oldValue=b}});b.on("keyup focus",".tdc-tab-no-design .tdc-property-textfield input",
function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var a=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(a,jQuery(this).data("param_name"),this.oldValue,b);this.oldValue=b}});b.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this);var a=b.val();b.is(":checked")||(a="");var c=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(c,
b.data("param_name"),this.oldValue,a);this.oldValue=a}});b.on("click",".tdc-tab-no-design .tdc-image-wrap",tdcSidebarPanel.tdcImageWrapHandler);b.on("click",".tdc-tab-no-design .tdc-image-remove",tdcSidebarPanel.tdcImageRemoveHandler);b.on("change keyup focus",".tdc-tab-no-design .tdc-property-colorpicker input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var a=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(a,jQuery(this).data("param_name"),
this.oldValue,b);this.oldValue=b}});b.on("change focus",".tdc-tab-no-design .tdc-row-col-dropdown select",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var a=tdcSidebar.getCurrentRow().data("model_id"),a=tdcIFrameData.getModel(a);"11"===this.oldValue&&("23_13"===b||"13_23"===b||"13_13_13"===b)||"23_13"===this.oldValue&&("11"===b||"13_23"===b||"13_13_13"===b)||"13_23"===this.oldValue&&("11"===b||"23_13"===b||"13_13_13"===b)||"13_13_13"===this.oldValue&&
("11"===b||"23_13"===b||"13_23"===b)?(tdcIFrameData.changeRowModel(a,this.oldValue,b),a.getShortcodeRender(1,null,!0)):tdcNotice.notice("Invalid row change detected: this.oldValue:"+this.oldValue+" and curValue: "+b,!1,!0);this.oldValue=b}});b.on("change focus",".tdc-tab-no-design .tdc-innerRow-col-dropdown select",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var a=tdcSidebar._$currentInnerRow.data("model_id"),a=tdcIFrameData.getModel(a);tdcIFrameData.changeInnerRowModel(a,
this.oldValue,b);a.getShortcodeRender(tdcIFrameData.getColumnNumber(a),null,!0);this.oldValue=b}});b.on("change focus",".tdc-tab-no-design .tdc-widget-sidebar-dropdown select",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var a=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(a,jQuery(this).data("param_name"),this.oldValue,b);this.oldValue=b}});b.on("click",".tdc-tab-no-design .tdc-open-wpeditor",function(b){b.preventDefault();
var a=jQuery(this);b=jQuery("#tdc-wpeditor");var c=b.children(".content"),d=a.data("model_id"),a=a.data("mapped_parameter_name");c.addClass("tdc-dropped");c.html('<iframe id="tdc-iframe-wpeditor" src="'+window.tdcAdminSettings.pluginUrl+'/includes/wpeditor.php" scrolling="auto" style="width: 100%; height: 100%" data-model_id="'+d+'" data-mapped_parameter_name="'+a+'"></iframe>');b.show()});b.on("click","#tdc-wpeditor #tdc-iframe-close-button",function(b){b.preventDefault();jQuery("#tdc-wpeditor").hide()})},
tdcImageWrapHandler:function(b){var d=jQuery(b.currentTarget);d.closest(".tdc-tab-content");window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(d);jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(b){var a=jQuery("img",b).attr("src"),g="";"undefined"===typeof a?(a=jQuery(b).attr("src"),
g=jQuery(b).attr("class")):g=jQuery("img",b).attr("class");jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:g,action:"tdc_ajax_get_image_id"}}).done(function(b,c,g){"success"===c&&(_.isObject(b)&&_.has(b,"errors")?tdcNotice.notice(b.errors,!0,!1):(d.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),
d.attr("style","background-image: url( '"+a+"') "),d.data("image_link",a),d.data("image_id",b.image_id),d.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),c="",g=d.data("model_id"),g=tdcIFrameData.getModel(g),d.hasClass("tdc-no-image-selected")||(c=b.image_id.toString()),tdcSidebarController.onUpdate(g,d.data("param_name"),"",c)))}).fail(function(b,a,c){})};return!1},tdcImageRemoveHandler:function(b){var d=jQuery(b.currentTarget);b=d.closest(".tdc-property-wrap").find(".tdc-image-wrap");
...
d)){var a=window.tdcAdminSettings.mappedShortcodes[b.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=b;for(var c=[],g=0;g<a.params.length;g++){var e=tdcSidebarPanel._defaultGroupName;_.isEmpty(a.params[g].group)||(e=a.params[g].group);c.push(e)}var c=_.uniq(c),f=e="",m=tdcSidebar.getCurrentTabId(),l,n,k,r,e=e+'<div class="tdc-tabs">';k=n=l="";for(g=0;g<c.length;g++)f=tdcSidebarPanel._fixGroupName(c[g]),r=tdcUtil.makeSafeForCSS(f),
0===g?(l='<a href="#" data-tab-id="td-tab-'+r+'" class="tdc-tab-active" title="'+f+' settings">'+f+"</a>",n='<a href="#" data-tab-id="td-tab-'+r+'" title="'+f+' settings">'+f+"</a>"):_.isUndefined(m)||m!=="td-tab-"+r?k+='<a href="#" data-tab-id="td-tab-'+r+'" title="'+f+' settings">'+f+"</a>":(l=n,k+='<a href="#" data-tab-id="td-tab-'+r+'" class="tdc-tab-active" title="'+f+' settings">'+f+"</a>");e=e+(l+k)+'</div><div class="tdc-tab-content-wrap">';k=n=l="";for(g=0;g<c.length;g++)f=tdcSidebarPanel._fixGroupName(c[g]),
r=tdcUtil.makeSafeForCSS(f),f="tdc-tab-no-design","css"===r&&(f="tdc-tab-design"),0===g?(l='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+r+'">',n='<div class="tdc-tab-content '+f+'" id="td-tab-'+r+'">'):_.isUndefined(m)||m!=="td-tab-"+r?k+='<div class="tdc-tab-content '+f+'" id="td-tab-'+r+'">':(l=n,k+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+r+'">'),k+=tdcSidebarPanel._bindGroupAndGetHtml(c[g],a,b),k+="</div>";e=e+(l+k)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(e);
jQuery(".tdc-breadcrumbs").show();tdcSidebarPanel._hook.doAction("panel_rendered");tdcSidebarPanel._hook.doAction("panel_css");(function(){if("vc_row"===b.get("tag")){var a=jQuery("body .tdc-row-col-dropdown select"),c=jQuery("body .tdc-row-stretch-dropdown select"),d=b.get("childCollection");if(!_.isUndefined(d)){d=tdcIFrameData.getChildCollectionWidths(d);_.isUndefined(d)&&(d="11");a.val(d);var a=b.get("attrs"),f;_.has(a,"full_width")&&(f=a.full_width);_.isUndefined(f)&&(f="");c.val(f)}}})();(function(){if("vc_row_inner"===
b.get("tag")){var a=jQuery("body .tdc-innerRow-col-dropdown select"),c=b.get("childCollection");if(!_.isUndefined(c)){c=tdcIFrameData.getChildCollectionWidths(c);_.isUndefined(c)&&(c="11");a.val(c);var c=b.get("parentModel").get("attrs"),d="";_.has(c,"width")&&(d=c.width.replace("/",""));switch(d){case "":a.find("option[value=12_12]").hide();a.find("option[value=23_13]").show();a.find("option[value=13_23]").show();a.find("option[value=13_13_13]").show();break;case "13":a.find("option[value=12_12]").hide();
a.find("option[value=23_13]").hide();a.find("option[value=13_23]").hide();a.find("option[value=13_13_13]").hide();break;case "23":a.find("option[value=12_12]").show(),a.find("option[value=23_13]").hide(),a.find("option[value=13_23]").hide(),a.find("option[value=13_13_13]").hide()}}}})()}},_bindGroupAndGetHtml:function(b,d,a){for(var c="",e=0;e<d.params.length;e++)b===tdcSidebarPanel._defaultGroupName?_.isEmpty(d.params[e].group)&&(c+=tdcSidebarPanel._bindParamAndGetHtml(d.params[e],a)):d.params[e].group===
b&&(c+=tdcSidebarPanel._bindParamAndGetHtml(d.params[e],a));return c},_bindParamAndGetHtml:function(b,d){switch(b.type){case "colorpicker":return tdcSidebarPanel.addColorpicker(b,d);case "dropdown":return tdcSidebarPanel.addDropDown(b,d);case "checkbox":return tdcSidebarPanel.addCheckBox(b,d);case "attach_image":return tdcSidebarPanel.addUploadImage(b,d);case "textfield":return tdcSidebarPanel.addTextField(b,d);case "textarea_html":return tdcSidebarPanel.addTextAreaHtml(b,d);case "textarea_raw_html":return tdcSidebarPanel.addTextAreaRawHtml(b,
...
d){var a="";if("undefined"===typeof d)return a;a+=' data-model_id="'+d.cid+'"';"undefined"!==typeof b&&(a+=' data-param_name="'+b.param_name+'"');return a},_fixGroupName:function(b){switch(b){case "Design options":return"Css";case "Pagination":return"Extra";case "Ajax filter":return"Ajax"}return b},clearPanel:function(){tdcSidebarPanel._deletePanel()},addColorpicker:function(b,d){var a="";_.has(b,"description")&&""!==b.description&&(a=' title="'+b.description+'" ');var c="",e=_.uniqueId(),c=c+('<div class="'+
tdcSidebarPanel._getParameterClasses(b)+'">'),c=c+('<div class="tdc-property-title"><span'+a+">"+b.heading+"</span></div>"),c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(b,d)+' id="'+e+'" name="'+tdcSidebarPanel._getParameterDomName(b)+'" type="text" value="'+tdcSidebarPanel._getParameterCurrentValue(b,d)+'"/>'),c=c+"</div></div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery("#"+e).cs_wpColorPicker()});return c},addDropDown:function(b,d){for(var a=
"",c="",e=Object.keys(b.value),h=0;h<e.length;h++){var f=b.value[e[h]],m=tdcSidebarPanel._getParameterCurrentValue(b,d),l="";String(m)===String(f)&&(l=' selected="selected" ');c+="<option "+l+' value="'+f+'">'+e[h]+"</option>"}e="";_.has(b,"description")&&""!==b.description&&(e=' title="'+b.description+'" ');a+='<div class="'+tdcSidebarPanel._getParameterClasses(b)+'">';a+='<div class="tdc-property-title"><span'+e+">"+b.heading+"</span></div>";a=a+'<div class="tdc-property">'+("<select "+tdcSidebarPanel._getParamterDataAtts(b,
...
d)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");c+='</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(a,c){var e=jQuery(c);if(!e.parent().parent(".tdc-bg-upload").length&&b.param_name===e.data("param_name")){var g=tdcSidebarPanel._getParameterCurrentValue(b,d);""!==g&&jQuery.ajax({timeout:1E4,type:"POST",
url:tdcUtil.getRestEndPoint("td-composer/get_image_url","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:g,action:"tdc_ajax_get_image_url"}}).done(function(a,b,c){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?tdcNotice.notice(a.errors,!0,!1):(e.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),e.data("image_link",a.image_url),e.data("image_id",
g),e.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,b,c){})}})});return c},addTextArea:function(){},addTextField:function(b,d){var a="";_.has(b,"description")&&""!==b.description&&(a=' title="'+b.description+'" ');var c;c=""+('<div class="'+tdcSidebarPanel._getParameterClasses(b)+'">');c+='<div class="tdc-property-title"><span'+a+">"+b.heading+"</span></div>";c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(b,
d)+' name="'+tdcSidebarPanel._getParameterDomName(b)+'" type="text" value="'+tdcSidebarPanel._getParameterCurrentValue(b,d)+'"/>');return c+"</div></div>"},addTextAreaHtml:function(b,d){_.has(b,"description");var a='<a href="#" class="tdc-open-wpeditor" data-model_id="'+d.cid+'" data-mapped_parameter_name="'+b.param_name+'">Edit Content</a>';tdcSidebarPanel._hook.addAction("panel_rendered",function(){});return a},addTextAreaRawHtml:function(b,d){var a=_.uniqueId("tdc_textarea_"),c="";_.has(b,"description")&&
""!==b.description&&(c=' title="'+b.description+'" ');var e;e=""+('<div class="'+tdcSidebarPanel._getParameterClasses(b)+'">');e+='<div class="tdc-property-title"><span'+c+">"+b.heading+"</span></div>";e=e+'<div class="tdc-property">'+('<textarea id="'+a+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(b,d)+">"+tdcSidebarPanel._getParameterCurrentValue(b,d)+"</textarea>");e+="</div></div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(b,d)}}).done(function(b,c,d){"success"===c&&(_.isObject(b)&&_.has(b,"errors")?tdcNotice.notice(b.errors,!0,!1):jQuery("#"+a).html(b.parsed_content).show())}).fail(function(a,b,c){});jQuery("body").on("keyup","#"+a,function(a){a=
jQuery(a.target);var b=tdcIFrameData.getModel(a.data("model_id")),c=window.btoa(a.val());tdcSidebarController.onUpdate(b,a.data("param_name"),c,c)});return e},addSeparatorHorizontal:function(b,d){return""+('<div class="tdc-sidebar-horizontal-separator '+tdcSidebarPanel._getParameterClasses(b)+'"></div>')}}})();var tdcUtil={};
